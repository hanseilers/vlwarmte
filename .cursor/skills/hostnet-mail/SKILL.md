...
Logo in mail is **`assets/img/vlwarmte-email-logo.png`** (PNG — veel clients tonen **geen SVG** in e-mail). Zonder “Afbeeldingen laden” zie je alsnog de **oranje VLWarmte-tekst** onder het blok.
